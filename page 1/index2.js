...
// le serach param sert a récuperer une element de l'url pour le réutilisé ensuite. ici j'ai récuperer l'id pour pouvoir le réutilisé et effectuer un second fetch
...
function magain(data) {
    ...
    // cela permet de coonné une cle a la valeur, car on ne peux pas stocker un objet sans cle ici la cle est "filmInfo" et la valeur est objectStringinfie
